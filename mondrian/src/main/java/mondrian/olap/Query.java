...
public class Query extends QueryPart {
  ...
  /**
   * Implementation of {@link mondrian.olap.Validator} that works within a particular query.
   *
   * <p>
   * It's unlikely that we would want a validator that is NOT within a particular query, but by organizing the code this
   * way, with the majority of the code in {@link mondrian.olap.ValidatorImpl}, the dependencies between Validator and
   * Query are explicit.
   */
