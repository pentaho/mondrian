...
import mondrian.spi.impl.MariaDBDialect;
import mondrian.spi.impl.MicrosoftSqlServerDialect;
import mondrian.spi.impl.MonetDbDialect;
import mondrian.spi.impl.MySqlDialect;
import mondrian.spi.impl.NetezzaDialect;
import mondrian.spi.impl.NuoDbDialect;
import mondrian.spi.impl.OracleDialect;
import mondrian.spi.impl.PostgreSqlDialect;
import mondrian.spi.impl.VectorwiseDialect;
...
/**
 * Unit test which checks that {@link mondrian.spi.Dialect} accurately represents the capabilities of the underlying
 * database.
 *
