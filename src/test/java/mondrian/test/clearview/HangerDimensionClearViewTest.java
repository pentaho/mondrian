 ...
 * HangerDimensionClearViewTest.ref.xml file. If you would prefer to see them as
 * inlined Java string literals, run ant target "generateDiffRepositoryJUnit"
 * and then use file HangerDimensionTestJUnit.java which will be generated in
 * this directory.</p>
 *
 * @author Khanh Vu
 */
