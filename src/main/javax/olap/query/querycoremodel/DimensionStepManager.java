...
public interface DimensionStepManager extends NamedObject {
...
// class operations
public DimensionStep createDimensionStep( DimensionStepType stepType)
throws OLAPException; public DimensionStep createDimensionStepBefore( DimensionStepType
stepType, DimensionStep member) throws OLAPException; public DimensionStep createDimensionStepAfter( DimensionStepType
stepType, DimensionStep member) throws OLAPException;
}
