...
import java. util.*;
public class OperatorEnum implements Operator {
...
private OperatorEnum( String literalName) {
...
if( o instanceof OperatorEnum) return (o == this); else if( o instanceof Operator) return
