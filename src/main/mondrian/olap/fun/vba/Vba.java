...
//    public Currency cCur(Object expression)
    ...
    public Date cDate(Object expression) throws ParseException { // TODO: test
    ...
    public static double cDbl(Object expression) { // TODO: test
...
//    public Object error(Object errorNumber)
    ...
    @Description("See Int.")
    public Object fix(Object number) { // todo: implement & test
        return 0;
    }

//    public String hex$(Object number)
    ...
    public Object int_(Object number) { // todo: implement & test
        return 0;
    }
...
//    public String oct$(Object number)
    ...
    public String oct(int number) { // todo:
        return null;
    }
...
//    public String str$(Object number)
    ...
    @Description("Returns a Variant (String) representing the octal value of a number.")
    public Object str(Object number) {
    ...
    public double val(String string) {
...
//    public void date$(String val)
    ...
    public static Date dateAdd(String intervalName, double number, Date date) {
        ...
        if (floor != number) {
            ...
            final long amount =
                (long) (((double) (ceilMillis - floorMillis))
                    * (number - floor));
            calendar.add(
    ...
    {
        return _datePart(
            interval, date, Calendar.SUNDAY, FirstWeekOfYear.vbFirstJan1);
    }
...
//    public String dir(Object pathName, FileAttribute attributes /* default FileAttribute.Normal */)
...
//
    ...
    public double dDB(
        double cost, double salvage, double life, double period, Object factor)
    { // TODO: implement & test
        return 0;
    }
    ...
    public static double fV(
        double rate, double nPer, double pmt, double pv, boolean type)
    {
        if (rate == 0) {
            return -(pv + (nPer * pmt));
        } else {
    ...
    public double iPmt(
        double rate, double per, double nPer, double PV, Object fv, Object due)
    {
        return -1; // todo:
    }
    ...
    public double IRR(double valueArray, Object guess) {
        return -1; // todo:
    }
    ...
    public double MIRR(
        double valueArray, double financeRate, double reinvestRate)
    {
        return -1; // todo:
    }
    ...
    public static double nPer(
        double rate, double pmt, double pv, double fv, boolean due)
    {
        if (rate == 0) {
            return -(fv + pv) / pmt;
        } else {
    ...
    public static double pmt(
        double rate, double nPer, double pv, double fv, boolean due)
    {
        if (rate == 0) {
            return -(fv + pv) / nPer;
        } else {
    ...
    public static double pV(
        double rate, double nper, double pmt, double fv, boolean due)
    {
        if (rate == 0) {
            return -((nper * pmt) + fv);
        } else {
            double r1 = rate + 1;
            return (((1 - Math.pow(r1, nper)) / rate) * (due ? r1 : 1) * pmt
                - fv)
                /
                Math.pow(r1, nper);
        }
    ...
    public double sYD(double cost, double salvage, double life, double period) {
        return -1; // todo:
    }
...
//    public Object iMEStatus()
    ...
    public boolean isDate(Object expression) {
        // todo: also allow expressions which can be converted to date
...
//    public int RGB(int red, int green, int blue)
    ...
    public String typeName(Object varName) {
...
//    public void beep()
//    public Object callByName(Object object, String procName, CallType callType, Object args, int lcid)
...
//    public String getSetting(String appName, String section, String key, Object Default)
//    public Object iIf(Object expression, Object truePart, Object falsePart)
//    public String inputBox(Object prompt, Object title, Object Default, Object xPos, Object yPos, Object helpFile, Object context)
//    public String macScript(String script)
//    public MsgBoxResult msgBox(Object prompt, MsgBoxStyle buttons /* default MsgBoxStyle.OKOnly */, Object title, Object helpFile, Object context)
//    public Object partition(Object number, Object start, Object stop, Object interval)
...
//    public double shell(Object pathName, AppWinStyle windowStyle /* default AppWinStyle.MinimizedFocus */)
...
//    public Object filter(Object sourceArray, String match, boolean include /* default 1 */, int compare /* default BinaryCompare */)
//    public String format$(Object expression, Object format, int firstDayOfWeek /* default Sunday */, int firstWeekOfYear /* default FirstJan1 */)
    ...
    public String formatDateTime(Object expression, String namedFormat /* default GeneralDate */) { // todo: implement & test
        return null;
    }

    @FunctionName("Format")
    @Signature("Format(expression[, format[, firstdayofweek[, firstweekofyear]]])")
    @Description("Returns a Variant (String) containing an expression formatted according to instructions contained in a format expression.")
    public Object format(
        Object expression,
        Object format,
        int firstDayOfWeek /* default sunday */,
        int firstWeekOfYear /* default FirstJan1 */)
    { // todo: implement @ test
        return null;
    }
...
//    public Object inStrB(Object start, Object string1, Object string2, int compare /* default BinaryCompare */)
    ...
    public Object inStr(
        Object start,
        Object string1,
        Object string2, int compare /* default BinaryCompare */)
    {
        return null; // todo:
    }
...
//    public Object lenB(Object expression)
    ...
    @Description("Returns a Long containing the number of characters in a string.")
    public Object len(String expression) {
        return expression.length(); // todo: test
    }
...
//    public Object split(String expression, Object delimiter, int limit /* default -1 */, int compare /* default BinaryCompare */)
    ...
    public int strComp(
        String string1, String string2, int compare/* default BinaryCompare */)
    {
        // todo: test
...
//    public String uCase$(String string)
    ...
    public static String weekdayName(
        int weekday, boolean abbreviate, int firstDayOfWeek)
    {
