...
public class BuiltinFunTable extends FunTable {
     ...
     */
    private Map mapNameToResolvers;
    ...
    private static Exp convert_(Exp fromExp, int to) {
        ...
        case Category.Dimension:
            ...
            case Category.Member:
                ...
                return new FunCall("CurrentMember", 
                                   Syntax.Property, 
                                   new Exp[]{fromExp});
            default:
                return null;
    ...
    protected void defineFunctions() {
        ...
        define(new FunDefBase(
            ...
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                ...
                OlapElement o = (s.startsWith("["))
                    ? evaluator.getSchemaReader().lookupCompound(cube,
                                                                 explode(s), 
                                                                 false, 
                                                                 Category.Level)
        ...
        define(new FunDefBase(
            ...
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                ...
                Member cousin = cousin(evaluator.getSchemaReader(), 
                                       member, 
                                       ancestorMember);
        ...
        define(new FunkResolver(
            "Covariance", 
            "Covariance(<Set>, <Numeric Expression>[, <Numeric Expression>])", "Returns the covariance of two series evaluated over a set (biased).",
            new String[]{"fnxn","fnxnn"},
            new FunkBase() {
                public Object evaluate(Evaluator evaluator, Exp[] args) {
                    List members = (List) getArg(evaluator, args, 0);
        ...
        define(new FunDefBase(
            ...
            "fxx"){
                ...
                public Object evaluate(Evaluator evaluator, Exp[] args) {
                    List list = (List) getArg(evaluator, args, 0);
                    java.util.Set hashSet = new HashSet(list.size());
        ...
        define(new FunDefBase(
            "Filter", 
            "Filter(<Set>, <Search Condition>)", "Returns the set resulting from filtering a set based on a search condition.", 
            "fxxb") {
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                List members = (List) getArg(evaluator, args, 0);
                Exp exp = args[1];
        ...
        define(new MultiResolver(
            ...
            new String[] {"fxxx", "fxxxy"}) {
            protected FunDef createFunDef(Exp[] args, FunDef dummyFunDef) {
                final boolean all = getLiteralArg(args, 
                        2, "", 
                        new String[] {"ALL"}, 
                        dummyFunDef).equalsIgnoreCase("ALL");
                return new FunDefBase(dummyFunDef) {
                    public Object evaluate(Evaluator evaluator, Exp[] args) {
                        List members = (List) getArg(evaluator, args, 0);
                        List result = new ArrayList();
                        java.util.Set emitted = all ? null : new HashSet();
            ...
            new FunkBase() {
                public Object evaluate(Evaluator evaluator, Exp[] args) {
                    ...
                    final int end = (args.length < 3)
                        ? members.size()
                        : start + getIntArg(evaluator, args, 2);

                    return ((start >= end) || (start < 0))
                        ? new ArrayList()
                        : ((start == 0) && (end >= members.size()))
                            ? members
            ...
            new FunkBase() {
                public Object evaluate(Evaluator evaluator, Exp[] args) {
                    ...
                    return (count >= members.size())
                        ...
                        : (count <= 0) 
                            ? new ArrayList()
                            : members.subList(members.size() - count, members.size());
                }
            }));
                ...
                return new FunDefBase(dummyFunDef) {
                    public Object evaluate(Evaluator evaluator, Exp[] args) {
                        ...
                        if (all) {
                            ...
                            java.util.Set added = new HashSet();
                            List result = new ArrayList();
        ...
        define (new FunkResolver(
            "Item", 
            "<Set>.Item(<Index>)", 
            "Returns the <Index>th element in the set, or ", new String[] {"mtxn", 
            "mmtn"},
            new FunkBase() {
                ...
                public Object evaluate(Evaluator evaluator, Exp[] args) {
                    ...
                    throw MondrianResource.instance().newItemIndexOutOfBounds(
                        Integer.toString(index), Integer.toString(setSize - 1));
                }
            }));
        ...
        define(new ResolverBase(
            ...
            public FunDef resolve(Exp[] args, int[] conversionCount) {
                ...
                return (args.length == 1)
                    ? new ParenthesesFunDef(args[0].getType())
            ...
            public FunDef resolve(Exp[] args, int[] conversionCount) {
                ...
                for (int j = 0; j < types.length; j++) {
                    ...
                    if (matchingArgs == args.length) {
                        return new CoalesceEmptyFunDef(this, 
                            type, ExpBase.getTypes(args));
                    }
                }
                return null;
            }
        ...
        define(new ResolverBase(
            ...
            public FunDef resolve(Exp[] args, int[] conversionCount) {
                ...
                if (mismatchingArgs == 0) {
                    return new FunDefBase(this, returnType, 
            ...
            protected FunDef createFunDef(Exp[] args, FunDef dummyFunDef) {
                ...
                case Category.Dimension:
                    ...
                    if (hierarchy == null || !isConstantHierarchy(typeArg)) {
                        throw newEvalException(dummyFunDef, 
                            "Invalid hierarchy for parameter '" 
                            + parameterName + "'");
                    }
                ...
                if (type == Category.Member) {
                    ...
                    if (expHierarchy != hierarchy) {
                        throw newEvalException(dummyFunDef, 
                            "Default value of parameter '" 
                            + parameterName 
                            + "' must belong to the hierarchy " + hierarchy);
                    }
                }
                ...
                return new ParameterFunDef(dummyFunDef, 
                    parameterName, hierarchy, type, exp, parameterDescription);
            }
        });
        ...
        define(new MultiResolver(
            ...
            protected FunDef createFunDef(Exp[] args, FunDef dummyFunDef) {
                ...
                return new ParameterFunDef(dummyFunDef, parameterName, 
                    null, Category.Unknown, null, null);
            }
        });
        ...
        define(new FunDefBase(
            ...
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                ...
                return ((o0 == null) || (o1 == null))
                    ? null
                    : new Double(o0.doubleValue() + o1.doubleValue());
            }
        });
        ...
        define(new FunDefBase(
            ...
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                ...
                StringBuffer buf = new StringBuffer(o0.length()+o1.length());
                buf.append(o0);
                buf.append(o1);
                return buf.toString();
            }
        ...
        define(new FunDefBase(
            ...
            public Object evaluate(Evaluator evaluator, Exp[] args) {
                ...
                return ((b1 == null) || (b2 == null))
                    ? null
                    : Boolean.valueOf(b1.booleanValue() && b2.booleanValue());
            }
        });
