...
import mondrian.rolap.RolapNativeSet.SetConstraint;
...
class MemberExcludeConstraint implements TupleConstraint  {
    ...
    private final SetConstraint csc;
    private Map<RolapLevel, List<RolapMember>> roles;
        ...
        SetConstraint csc)
    {
        ...
        this.cacheKey = Arrays.asList(
            MemberExcludeConstraint.class, excludes, csc);
        this.level = level;
        this.csc = csc;
        
        if (csc != null) {
          roles = SqlConstraintUtils.getRolesConstraints(csc.getEvaluator());
        }
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof MemberExcludeConstraint
            && getCacheKey().equals(
                ((MemberExcludeConstraint) obj).getCacheKey());
    }
