...
public class RolapConnection extends ConnectionBase {
    ...
    private DataSource createDataSource(Util.PropertyList connectInfo) {
        ...
        if (jdbcConnectString != null) {
            ...
            try {
                return RolapConnectionPool.instance().getPoolingDataSource(connectionFactory);
            } catch (Throwable e) {
  ...
  public Locale getLocale()
  {
	 ...
	 */
	private static class RolapConnectionPool {

		private static RolapConnectionPool instance = null;
		...
		public static RolapConnectionPool instance() {
			if ( instance == null ) {
				instance = new RolapConnectionPool();
			}
			return instance;
		}
