 ...
 * in the {@link PrefDef#AggregateRules} value which normally is
...
public class DefaultRules {
    ...
    public static synchronized DefaultRules getInstance() {
        if (instance == null) {
            ...
            String tag = StatementPref.instance().AggregateRuleTag;
    ...
    private static InputStream getAggRuleInputStream() {
        String aggRules = StatementPref.instance().AggregateRules;
    ...
    private DefaultRules(final DefaultDef.AggRules rules) {
        ...
        this.tag = PrefDef.AggregateRuleTag.getDefaultValue();
    }
     ...
     * {@link PrefDef#AggregateRuleTag} property).
     */
