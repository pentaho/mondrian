 ...
 * in the MondrianProperties AggregateRules value which normally is
 * a resource in the jar file (but can be a url).
 * It is a singleton since it is used to recognize tables independent of
 * database connection (each RolapSchema uses the same instance).
 * 
...
public class DefaultRules {
    ...
    /** 
     * There is a single instance of the DefaultRecognizer and the DefaultRules
    ...
    /** 
     * Get the tag of this rule (this is the value of the
    ...
    /** 
     * This gets the AggRule whose tag equals the parameter tag or null. 
     * 
     * @param tag 
    ...
    /** 
     * Get the Matcher for this tableName. 
     * 
     * @param tableName 
     * @return 
     */
    ...
    /** 
     * Get the fact count column Matcher. 
     * 
     * @return 
     */
    ...
    /** 
     * Get the Matcher for this foreign key column name. 
     * 
     * @param foreignKeyName 
     * @return 
     */
    public Recognizer.Matcher getForeignKeyMatcher(final String foreignKeyName) {
        Recognizer.Matcher matcher = 
    ...
    /** 
     * Create a Matcher for the given measure name (symbolic name), column
     * name and aggregate name (sum, count, etc.).
     * 
     * @param measureName 
    ...
    /** 
     * Get a Matcher for a given level's hierarchy's name, level name and
     * column name.
     * 
     * @param hierarchyName 
     * @param levelName 
    ...
    /** 
     * This method uses the DefaultRecognizer Recognizer to determine if the
    ...
    public boolean columnsOK(final RolapStar star, 
        ...
        Recognizer cb = new DefaultRecognizer(this,
                                              star,
                                              dbFactTable,
                                              aggTable,
                                              msgRecorder);
