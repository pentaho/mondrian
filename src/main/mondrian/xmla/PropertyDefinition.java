...
class PropertyDefinition extends EnumeratedValues.BasicValue {
     ...
     */
    public PropertyDefinition(String name, int ordinal, RowsetDefinition.Type type, EnumeratedValues enumeration, Enumeration.Access access, String dflt, Enumeration.Methods usage, String description) {
    ...
    static final PropertyDefinition AxisFormat = new PropertyDefinition("AxisFormat", AxisFormat_ORDINAL, RowsetDefinition.Type.Enumeration, Enumeration.AxisFormat.enumeration, Enumeration.Access.write, "", Enumeration.Methods.execute,
    ...
    static final PropertyDefinition BeginRange = new PropertyDefinition("BeginRange", BeginRange_ORDINAL, RowsetDefinition.Type.Integer, null, Enumeration.Access.write, "-1", Enumeration.Methods.execute, "An integer value corresponding to a CellOrdinal used to restrict an MDDataSet returned by a command to a specific range of cells. Used in conjunction with the EndRange property. If unspecified, all cells are returned in the rowset. The value -1 means unspecified.");
    public static final int Catalog_ORDINAL = 2;
    static final PropertyDefinition Catalog = new PropertyDefinition("Catalog", Catalog_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.readWrite, null, Enumeration.Methods.discoverAndExecute, "Specifies the initial catalog or database on which to connect.");
    public static final int Content_ORDINAL = 3;
    static final PropertyDefinition Content = new PropertyDefinition("Content", Content_ORDINAL, RowsetDefinition.Type.EnumString, Enumeration.Content.enumeration, Enumeration.Access.write,
                    "SchemaData", Enumeration.Methods.discoverAndExecute,
    ...
    static final PropertyDefinition Cube = new PropertyDefinition("Cube", Cube_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.readWrite, "", Enumeration.Methods.execute,
    ...
    static final PropertyDefinition DataSourceInfo = new PropertyDefinition("DataSourceInfo", DataSourceInfo_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.readWrite, "", Enumeration.Methods.discoverAndExecute,
    ...
    static final PropertyDefinition EndRange = new PropertyDefinition("EndRange", EndRange_ORDINAL, RowsetDefinition.Type.Integer, null, Enumeration.Access.write, "-1", Enumeration.Methods.execute,
    ...
    static final PropertyDefinition Format = new PropertyDefinition("Format", Format_ORDINAL, RowsetDefinition.Type.EnumString, Enumeration.Format.enumeration, Enumeration.Access.write, "Native", Enumeration.Methods.discoverAndExecute,
    ...
    static final PropertyDefinition Password = new PropertyDefinition("Password", Password_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.read, "", Enumeration.Methods.discoverAndExecute,
    ...
    static final PropertyDefinition ProviderName = new PropertyDefinition("ProviderName", ProviderName_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.read, "", Enumeration.Methods.discover,
                    "The XML for Analysis Provider name.");
    public static final int ProviderVersion_ORDINAL = 12;
    static final PropertyDefinition ProviderVersion = new PropertyDefinition("ProviderVersion", ProviderVersion_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.read, "", Enumeration.Methods.discover,
    ...
    static final PropertyDefinition StateSupport = new PropertyDefinition("StateSupport", StateSupport_ORDINAL, RowsetDefinition.Type.EnumString, Enumeration.StateSupport.enumeration, Enumeration.Access.read, "None", Enumeration.Methods.discover,
    ...
    static final PropertyDefinition Timeout = new PropertyDefinition("Timeout", Timeout_ORDINAL, RowsetDefinition.Type.UnsignedInteger, null, Enumeration.Access.readWrite, "Undefined", Enumeration.Methods.discoverAndExecute,
    ...
    static final PropertyDefinition UserName = new PropertyDefinition("UserName", UserName_ORDINAL, RowsetDefinition.Type.String, null, Enumeration.Access.read, "", Enumeration.Methods.discoverAndExecute,
