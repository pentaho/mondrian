...
/**
 * Unit test for error when 4.x schema has no metamodelVersion attribute.
 */
public class SchemaMetamodelVersionTest extends FoodMartTestCase {

    public SchemaMetamodelVersionTest(String name) {
      super(name);
    }
    ...
    public void testV4SchemaWithHeader() {
        ...
        RolapConnection conn =
            new RolapConnection(server, connectionInfo, null);
    ...
    private static String SCHEMA_V4_HEADER = "<?xml version='1.0'?>\n"
        + "<Schema name='MiniFoodMart' metamodelVersion='4.0'>\n";

    private static String SCHEMA_NO_VERSION_HEADER = "<?xml version='1.0'?>\n"
    ...
    private static String SCHEMA_3_BODY =
