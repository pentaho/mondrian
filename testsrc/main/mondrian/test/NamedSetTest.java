...
public class NamedSetTest extends FoodMartTestCase {
    ...
    public void testNamedSetCrossJoin() {
        assertQueryReturns(
            ...
            + "Axis #2:\n"
            + "{[Store].[USA], [Store].[Store Type].[Deluxe Supermarket]}\n"
    ...
    public void testNamedSetUsedInCrossJoin() {
        assertQueryReturns(
            ...
            + "{[Time].[Time].[1997].[Q2]}\n"
            + "Axis #2:\n"
            + "{[Promotion].[Media Type].[No Media], [Product].[Drink]}\n"
            + "{[Promotion].[Media Type].[No Media], [Product].[Food]}\n"
            + "{[Promotion].[Media Type].[No Media], [Product].[Non-Consumable]}\n"
            + "{[Promotion].[Media Type].[Daily Paper, Radio, TV], [Product].[Drink]}\n"
            + "{[Promotion].[Media Type].[Daily Paper, Radio, TV], [Product].[Food]}\n"
            + "{[Promotion].[Media Type].[Daily Paper, Radio, TV], [Product].[Non-Consumable]}\n"
            + "{[Promotion].[Media Type].[Daily Paper], [Product].[Drink]}\n"
            + "{[Promotion].[Media Type].[Daily Paper], [Product].[Food]}\n"
            + "{[Promotion].[Media Type].[Daily Paper], [Product].[Non-Consumable]}\n"
            + "{[Promotion].[Media Type].[Product Attachment], [Product].[Drink]}\n"
            + "{[Promotion].[Media Type].[Product Attachment], [Product].[Food]}\n"
            + "{[Promotion].[Media Type].[Product Attachment], [Product].[Non-Consumable]}\n"
            + "{[Promotion].[Media Type].[Cash Register Handout], [Product].[Drink]}\n"
            + "{[Promotion].[Media Type].[Cash Register Handout], [Product].[Food]}\n"
            + "{[Promotion].[Media Type].[Cash Register Handout], [Product].[Non-Consumable]}\n"
            + "Row #0: 3,970\n"
            + "Row #0: 4,287\n"
            + "Row #1: 32,939\n"
            + "Row #1: 33,238\n"
    ...
    public void testNamedSetAndUnion() {
        assertQueryReturns(
            ...
            + "{[Measures].[Store Sales]}\n"
            + "Axis #2:\n"
            + "{[Time].[Time].[1997].[Q1], [Education Level].[Bachelors Degree]}\n"
            + "{[Time].[Time].[1997].[Q1], [Education Level].[Graduate Degree]}\n"
            + "Row #0: 17,066\n"
            + "Row #0: 14,234.10\n"
            + "Row #0: 35,699.43\n"
            + "Row #1: 3,637\n"
    ...
    public void testHierarchizeNamedSetImmutable() {
        assertQueryReturns(
            ...
            + "{[Measures].[Unit Sales]}\n"
            + "Axis #2:\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Tracy Meyer], [Store].[USA].[WA].[Yakima].[Store 23]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Vanessa Thompson], [Store].[USA].[WA].[Yakima].[Store 23]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Velma Lykes], [Store].[USA].[WA].[Yakima].[Store 23]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[William Battaglia], [Store].[USA].[WA].[Yakima].[Store 23]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Wilma Fink], [Store].[USA].[WA].[Yakima].[Store 23]}\n"
            + "Row #0: 44\n"
            + "Row #1: 128\n"
            + "Row #2: 55\n"
            + "Row #3: 149\n"
    ...
    public void testCurrentAndCurrentOrdinal() {
        assertQueryReturns(
            ...
            + "Row #0: 266,773\n"
            + "Row #0: 0\n"
            + "Row #0: ([Gender].[All Gender], [Customer].[Marital Status].[All Marital Status])\n"
            + "Row #1: 131,796\n"
            + "Row #1: 1\n"
            + "Row #1: ([Gender].[All Gender], [Customer].[Marital Status].[M])\n"
            + "Row #2: 134,977\n"
            + "Row #2: 2\n"
            + "Row #2: ([Gender].[All Gender], [Customer].[Marital Status].[S])\n"
            + "Row #3: 131,558\n"
            + "Row #3: 3\n"
            + "Row #3: ([Gender].[F], [Customer].[Marital Status].[All Marital Status])\n"
            + "Row #4: 65,336\n"
            + "Row #4: 4\n"
            + "Row #4: ([Gender].[F], [Customer].[Marital Status].[M])\n"
            + "Row #5: 66,222\n"
            + "Row #5: 5\n"
            + "Row #5: ([Gender].[F], [Customer].[Marital Status].[S])\n"
            + "Row #6: 135,215\n"
            + "Row #6: 6\n"
            + "Row #6: ([Gender].[M], [Customer].[Marital Status].[All Marital Status])\n"
            + "Row #7: 66,460\n"
            + "Row #7: 7\n"
            + "Row #7: ([Gender].[M], [Customer].[Marital Status].[M])\n"
            + "Row #8: 68,755\n"
            + "Row #8: 8\n"
            + "Row #8: ([Gender].[M], [Customer].[Marital Status].[S])\n");
    }
