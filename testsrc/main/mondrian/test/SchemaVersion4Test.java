...
public class SchemaVersion4Test extends FoodMartTestCase {

    public SchemaVersion4Test(String name) {
        super(name);
    }
    ...
    private static String SCHEMA_3_VHEADER = "<?xml version=\"1.0\"?>\n"
    ...
    private static String SCHEMA_4_HEADER = "<?xml version='1.0'?>\n"
        + "<Schema name='MiniFoodMart' metamodelVersion='4.0'>\n";

    private static String SCHEMA_4_NVHEADER = "<?xml version='1.0'?>\n"
        + "<Schema name='MiniFoodMart'>\n";
