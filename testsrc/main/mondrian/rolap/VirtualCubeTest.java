...
public class VirtualCubeTest extends BatchTestCase {
    ...
    public void testCalculatedMeasureAcrossCubes() {
        assertQueryReturns(
            ...
            + "{[Product].[Products].[Drink], [Time].[Time].[1997].[Q3]}\n"
            + "{[Product].[Products].[Drink], [Time].[Time].[1997].[Q4]}\n"
            + "{[Product].[Products].[Food], [Time].[Time].[1997].[Q1]}\n"
            + "{[Product].[Products].[Food], [Time].[Time].[1997].[Q2]}\n"
            + "{[Product].[Products].[Food], [Time].[Time].[1997].[Q3]}\n"
            + "{[Product].[Products].[Food], [Time].[Time].[1997].[Q4]}\n"
            + "{[Product].[Products].[Non-Consumable], [Time].[Time].[1997].[Q1]}\n"
            + "{[Product].[Products].[Non-Consumable], [Time].[Time].[1997].[Q2]}\n"
            + "{[Product].[Products].[Non-Consumable], [Time].[Time].[1997].[Q3]}\n"
            + "{[Product].[Products].[Non-Consumable], [Time].[Time].[1997].[Q4]}\n"
            + "Row #0: 5,976\n"
            + "Row #0: 4637.0\n"
            + "Row #0: 77.59%\n"
            + "Row #0: $1.50\n"
    ...
    public void testOrdinalColumn() {
        ...
        testContext.assertQueryReturns(
            ...
            + "non empty "
            + "crossjoin([Store].[Store Country].members, [Employee].[Position].[Store Management].children) "
            ...
            + "{[Measures].[Org Salary]}\n"
            + "Axis #2:\n"
            + "{[Store].[Canada], [Employee].[Position].[Store Management].[Store Manager]}\n"
            + "{[Store].[Canada], [Employee].[Position].[Store Management].[Store Assistant Manager]}\n"
            + "{[Store].[Canada], [Employee].[Position].[Store Management].[Store Shift Supervisor]}\n"
            + "{[Store].[Mexico], [Employee].[Position].[Store Management].[Store Manager]}\n"
            + "{[Store].[Mexico], [Employee].[Position].[Store Management].[Store Assistant Manager]}\n"
            + "{[Store].[Mexico], [Employee].[Position].[Store Management].[Store Shift Supervisor]}\n"
            + "{[Store].[USA], [Employee].[Position].[Store Management].[Store Manager]}\n"
            + "{[Store].[USA], [Employee].[Position].[Store Management].[Store Assistant Manager]}\n"
            + "{[Store].[USA], [Employee].[Position].[Store Management].[Store Shift Supervisor]}\n"
            + "Row #0: $462.86\n"
            + "Row #1: $394.29\n"
            + "Row #2: $565.71\n"
            + "Row #3: $13,254.55\n"
    ...
    public void testBugMondrian322() {
         ...
         */
        testContext.assertQueryReturns(
            "with member [Warehouses].[x] as 'Aggregate([Warehouse].members)'\n"
    ...
    public void testBugMondrian322a() {
        final TestContext testContext = TestContext.instance().create(
            ...
            null);
        testContext.assertQueryReturns(
            "with member [Warehouses].[x] as 'Aggregate({[Warehouse].[Canada], [Warehouse].[USA]})'\n"
            + "member [Measures].[foo] AS '([Warehouse].[x],[Measures].[Customer Count])'\n"
            + "select {[Measures].[foo]} on 0 from [Warehouse And Sales2]",
            "Axis #0:\n"
            + "{}\n"
    ...
    public void testRolapCubeLevelInVirtualCube() {
        ...
        String result =
            ...
            + "Axis #2:\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q1].[1]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q1].[3]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q2].[4]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q2].[5]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q2].[6]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q3].[7]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q3].[8]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q3].[9]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q4].[10]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q4].[11]}\n"
            + "{[Warehouse].[Warehouses].[USA], [Time].[Time].[1997].[Q4].[12]}\n"
            + "Row #0: 21,762\n"
            + "Row #1: 13,775\n"
            + "Row #2: 15,938\n"
            + "Row #3: 15,649\n"
    ...
    public void testNonEmptyCJConstraintOnVirtualCube() {
        ...
        String result =
            ...
            + "{[Measures].[Store Sales]}\n"
            + "Axis #2:\n"
            + "{[Time].[Time].[1997].[Q1].[1], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q1].[2], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q1].[3], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q2].[4], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q2].[5], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q2].[6], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q3].[7], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q3].[8], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q3].[9], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q4].[10], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q4].[11], [Store].[USA]}\n"
            + "{[Time].[Time].[1997].[Q4].[12], [Store].[USA]}\n"
            + "Row #0: 16,083.015\n"
            + "Row #0: 32,993.12\n"
            + "Row #1: 9,298.379\n"
            + "Row #1: 32,139.91\n"
