...
public class TestAggregationManager extends BatchTestCase {
    ...
    public void testLevelKeyAsSqlExpWithAgg() {
        ...
        final boolean oldUseAggValue = props.UseAggregates.get();
        final boolean oldReadAggValue = props.ReadAggregates.get();
        ...
        try {
            ...
            TestContext testContext = TestContext.createSubstitutingCube(
                    ...
                    + "      <KeyExpression><SQL>ERROR_TEST_FUNCTION_NAME(promotion_name)</SQL></KeyExpression>\n"
                    + "    </Level>\n"
                    + "  </Hierarchy>\n"
                    + "</Dimension>");
