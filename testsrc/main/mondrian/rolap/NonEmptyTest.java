...
public class NonEmptyTest extends BatchTestCase {
    ...
    public void testExpandAllNonNativeInputs() {
        ...
        checkNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Customer].[Gender].[F], [Store].[USA]}\n"
            + "{[Customer].[Gender].[M], [Store].[USA]}\n"
            + "Row #0: 131,558\n"
            + "Row #0: 135,215\n",
            requestFreshConnection);
    }
    ...
    public void testExpandCalcMembersInAllInputs() {
        ...
        checkNotNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Customer].[Gender].[*CTX_MEMBER_SEL~SUM], [Product].[*CTX_MEMBER_SEL~SUM]}\n"
            + "Row #0: 266,773\n");
    }
    ...
    public void testExpandCalcMemberInputNECJ() {
        ...
        checkNotNative(
            ...
            + "{[Measures].[Store Cost]}\n"
            + "Axis #2:\n"
            + "{[Product].[Products].[Food].[CalcSum], [Education Level].[All Education Levels]}\n"
            + "Row #0: 163,270.72\n");
    }
    ...
    public void testExpandNestedNonNativeInputs() {
        ...
        checkNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Customer].[Gender].[F], [Store].[USA], [Product].[Drink]}\n"
            + "{[Customer].[Gender].[F], [Store].[USA], [Product].[Food]}\n"
            + "{[Customer].[Gender].[F], [Store].[USA], [Product].[Non-Consumable]}\n"
            + "{[Customer].[Gender].[M], [Store].[USA], [Product].[Drink]}\n"
            + "{[Customer].[Gender].[M], [Store].[USA], [Product].[Food]}\n"
            + "{[Customer].[Gender].[M], [Store].[USA], [Product].[Non-Consumable]}\n"
            + "Row #0: 12,202\n"
            + "Row #0: 94,814\n"
            + "Row #0: 24,542\n"
            + "Row #0: 12,395\n"
    ...
    public void testExpandLowMaxConstraints() {
        ...
        checkNotNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Store].[Store Type].[Deluxe Supermarket], [Product].[Drink]}\n"
            + "{[Store].[Store Type].[Deluxe Supermarket], [Product].[Food]}\n"
            + "{[Store].[Store Type].[Deluxe Supermarket], [Product].[Non-Consumable]}\n"
            + "{[Store].[Store Type].[Gourmet Supermarket], [Product].[Drink]}\n"
            + "{[Store].[Store Type].[Gourmet Supermarket], [Product].[Food]}\n"
            + "{[Store].[Store Type].[Gourmet Supermarket], [Product].[Non-Consumable]}\n"
            + "{[Store].[Store Type].[Mid-Size Grocery], [Product].[Drink]}\n"
            + "{[Store].[Store Type].[Mid-Size Grocery], [Product].[Food]}\n"
            + "{[Store].[Store Type].[Mid-Size Grocery], [Product].[Non-Consumable]}\n"
            + "{[Store].[Store Type].[Supermarket], [Product].[Drink]}\n"
            + "{[Store].[Store Type].[Supermarket], [Product].[Food]}\n"
            + "{[Store].[Store Type].[Supermarket], [Product].[Non-Consumable]}\n"
            + "Row #0: 6,827\n"
            + "Row #0: 55,358\n"
            + "Row #0: 14,652\n"
            + "Row #0: 1,945\n"
    ...
    public void testExpandTupleInputs1() {
        ...
        checkNotNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Store].[USA], [Store].[Store Type].[Supermarket], [Product].[Food]}\n"
            + "Row #0: 108,188\n");
    }
    ...
    public void testExpandTupleInputs2() {
        ...
        checkNotNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Store].[Store Type].[Supermarket], [Product].[Food], [Store].[USA]}\n"
            + "Row #0: 108,188\n");
    }
    ...
    public void testAllMembersNECJ2() {
        ...
        checkNative(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Product].[Products].[Drink], [Store].[All Stores]}\n"
            + "{[Product].[Products].[Food], [Store].[All Stores]}\n"
            + "{[Product].[Products].[Non-Consumable], [Store].[All Stores]}\n"
            + "Row #0: 24,597\n"
            + "Row #0: 191,940\n"
            + "Row #0: 50,236\n",
            requestFreshConnection);
    ...
    public void testMeasureAndAggregateInSlicer() {
        assertQueryReturns(
            ...
            "Axis #0:\n"
            + "{[Store].[Store Type].[All Store Types].[All Types], [Measures].[Unit Sales], [Customer].[Customers].[USA], [Product].[Drink]}\n"
            + "Axis #1:\n"
            + "{[Time].[Time].[1997]}\n"
            + "Axis #2:\n"
    ...
    public void testMeasureInSlicer() {
        assertQueryReturns(
            ...
            "Axis #0:\n"
            + "{[Measures].[Unit Sales], [Customer].[Customers].[USA], [Product].[Drink]}\n"
            + "Axis #1:\n"
            + "{[Time].[Time].[1997]}\n"
            + "Axis #2:\n"
            + "{[Store].[USA].[CA].[Beverly Hills]}\n"
    ...
    public void testVCNativeCJWithIsEmptyOnMeasure() {
        ...
        assertQueryReturns(
            ...
            "Axis #0:\n"
            + "{[Education Level].[FILTER1], [Customer].[Gender].[FILTER2]}\n"
            + "Axis #1:\n"
            + "{[Measures].[Unit Sales]}\n"
            + "Axis #2:\n"
    ...
    public void testCrossjoinWithOneDimensionThatDoesNotJoinToBothBaseCubes() {
        assertQueryReturns(
            ...
            + "{}\n"
            + "Axis #1:\n"
            + "{[Store].[USA].[CA].[Beverly Hills].[Store 6], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[CA].[Beverly Hills].[Store 6], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[CA].[Los Angeles].[Store 7], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[CA].[Los Angeles].[Store 7], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[CA].[San Diego].[Store 24], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[CA].[San Diego].[Store 24], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[CA].[San Francisco].[Store 14], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[CA].[San Francisco].[Store 14], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[OR].[Portland].[Store 11], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[OR].[Portland].[Store 11], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[OR].[Salem].[Store 13], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[OR].[Salem].[Store 13], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Bellingham].[Store 2], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Bellingham].[Store 2], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Bremerton].[Store 3], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Bremerton].[Store 3], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Seattle].[Store 15], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Seattle].[Store 15], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Spokane].[Store 16], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Spokane].[Store 16], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Tacoma].[Store 17], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Tacoma].[Store 17], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Walla Walla].[Store 22], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Walla Walla].[Store 22], [Customer].[Gender].[M]}\n"
            + "{[Store].[USA].[WA].[Yakima].[Store 23], [Customer].[Gender].[F]}\n"
            + "{[Store].[USA].[WA].[Yakima].[Store 23], [Customer].[Gender].[M]}\n"
            + "Axis #2:\n"
            + "{[Measures].[Unit Sales]}\n"
            + "{[Measures].[vm]}\n"
            + "Row #0: 10,771\n"
    ...
    public void testExpandNonNativeWithEnableNativeCrossJoin() {
        ...
        assertQueryReturns(
            ...
            + "{[Measures].[Unit Sales]}\n"
            + "Axis #2:\n"
            + "{[Store].[All Stores], [Store Size in SQFT].[All Store Size in SQFTs], [Store Type].[All Store Types], [Time].[Time].[1997], [Product].[Products].[All Products], [Promotion].[Media Type].[All Media], [Promotions].[All Promotions], [Customer].[Customers].[All Customers], [Education Level].[All Education Levels], [Customer].[Gender].[All Gender], [Customer].[Marital Status].[All Marital Status], [Yearly Income].[All Yearly Incomes]}\n"
            + "{[Store].[All Stores], [Store Size in SQFT].[All Store Size in SQFTs], [Store Type].[All Store Types], [Time].[Time].[1997], [Product].[Drink], [Promotion].[Media Type].[All Media], [Promotions].[All Promotions], [Customer].[Customers].[All Customers], [Education Level].[All Education Levels], [Customer].[Gender].[All Gender], [Customer].[Marital Status].[All Marital Status], [Yearly Income].[All Yearly Incomes]}\n"
            + "{[Store].[All Stores], [Store Size in SQFT].[All Store Size in SQFTs], [Store Type].[All Store Types], [Time].[Time].[1997], [Product].[Food], [Promotion].[Media Type].[All Media], [Promotions].[All Promotions], [Customer].[Customers].[All Customers], [Education Level].[All Education Levels], [Customer].[Gender].[All Gender], [Customer].[Marital Status].[All Marital Status], [Yearly Income].[All Yearly Incomes]}\n"
            + "{[Store].[All Stores], [Store Size in SQFT].[All Store Size in SQFTs], [Store Type].[All Store Types], [Time].[Time].[1997], [Product].[Non-Consumable], [Promotion].[Media Type].[All Media], [Promotions].[All Promotions], [Customer].[Customers].[All Customers], [Education Level].[All Education Levels], [Customer].[Gender].[All Gender], [Customer].[Marital Status].[All Marital Status], [Yearly Income].[All Yearly Incomes]}\n"
            + "Row #0: 266,773\n"
            + "Row #1: 24,597\n"
            + "Row #2: 191,940\n"
            + "Row #3: 50,236\n");
