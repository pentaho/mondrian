...
public class NonEmptyTest extends BatchTestCase {
    ...
    public void testAnalyzerPerformanceIssue() throws Exception {
        boolean nativeCrossJoin = MondrianProperties.instance().EnableNativeCrossJoin.get();
        boolean nativeTopCount = MondrianProperties.instance().EnableNativeTopCount.get();
        boolean nativeFilter = MondrianProperties.instance().EnableNativeFilter.get();
        boolean nativeNonEmpty = MondrianProperties.instance().EnableNativeNonEmpty.get();
        ...
        try {
            ...
            MondrianProperties.instance().EnableNativeCrossJoin.set(nativeCrossJoin);
            MondrianProperties.instance().EnableNativeTopCount.set(nativeTopCount);        
            MondrianProperties.instance().EnableNativeFilter.set(nativeFilter);        
            MondrianProperties.instance().EnableNativeNonEmpty.set(nativeNonEmpty);
